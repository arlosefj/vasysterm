...
dbname = jsondata['databaseserver']['name']
dbip = jsondata['databaseserver']['ip']
dbport = jsondata['databaseserver']['port']
dbusrname = jsondata['databaseserver']['username']

ssip = jsondata['storageserver']['ip']
ssdir = jsondata['storageserver']['dir']

db = MySQLDatabase(dbname, host=dbip, user=dbusrname, passwd="knowvision")
db.connect()
