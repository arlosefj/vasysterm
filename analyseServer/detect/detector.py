...
class Detector(object):
    ...
    def visualize_detection(self, img, dets,pic_str, classes=[], thresh=0.6):
        """
    ...
    def detect_and_visualize(self, im_list,pic_str, root_dir=None, extension=None,
        ...
        for k, det in enumerate(dets):
            ...
            self.visualize_detection(img, det,pic_str, classes, thresh)
    
    def detect_coordinate(self, im_list, root_dir=None, extension=None,
                             classes=[], thresh=0.6, show_timer=False):
        """
        ...
        for k, det in enumerate(dets):
            ...
            for det_m in det:
                ...
                #输出json格式字符串
                obj_list.append('{\n%s"x_start": %d,\n%s"y_start": %d,\n%s"x_end": %d,\n%s"y_end": %d, \n%s"tag": %s, \n%s"info": %s\n%s}' 
                                %(" "*24,xmin," "*24, ymin," "*24, xmax," "*24, ymax," "*24, class_name," "*24, "疑似"+class_name, " "*20))
                length_str += 1
